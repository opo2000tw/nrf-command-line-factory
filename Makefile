...
package: dist
	...
	zip -q $(DIST)/nrf-factory-$(VERSION)-windows-amd64.zip $(DIST)/$(BIN_WIN) CHANGELOG.md docs/INSTALL-AND-RUN.md
	zip -q $(DIST)/nrf-factory-$(VERSION)-darwin-arm64.zip  $(DIST)/$(BIN_MAC_ARM) CHANGELOG.md docs/INSTALL-AND-RUN.md
